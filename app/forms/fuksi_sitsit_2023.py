...
Sitsien hinta on 22€. Maksu tapahtuu tilisiirrolla Oulun Tietoteekkarit ry:n tilille FI03 4744 3020 0116 87.
...
def _get_quotas(registration_start: datetime, registration_end: datetime) -> List[Quota]:
    ...
    return [
        fuksi_quota,
        Quota(_QUOTA_PRO,   15,    0,  registration_start, registration_end),
        Quota('Hallitus',   11,   0,  registration_start, registration_end),
        OtherQuota(fuksi_quota, 'Muu', 0, 0,  datetime(2023, 9, 8, 0, 0, 0),  registration_end)
    ]


_registration_start = datetime(2023, 9, 4, 12, 0, 0)
_registration_end = datetime(2023, 9, 10, 23, 59, 59)
