...
Sitsit järjestetään Tetralla sunnuntaina 27.9. klo 17 alkaen. Tapahtuman pukukoodi on cocktail.
...
The sitsit will be held at Tetra on Sunday, September 27, starting at 17:00. The dress code for the event is cocktail.
Please remember to arrive on time!

Do not reply to this email, responses will not be received."""
        else:
            return f"""Tervehdys, {firstname} {lastname}! Olet ilmoittautunut OTiT:n fuksisitseille.
Sitsit järjestetään Tetralla Sunday 27.9. klo 17 alkaen. Tapahtuman pukukoodi on cocktail.
Muistathan tulla ajoissa paikalle!

Maksuohjeet:
Sitsien hinta on 25 €. Maksu tapahtuu tilisiirrolla Oulun Tietoteekkarit ry:n tilille FI11 7997 7997 9204 70.
Kirjoita viestikenttään nimesi + fuksisitsit. Jos tulee kysyttävää, niin voit olla sähköpostitse yhteydessä pepeministeri@otit.fi.
...
The price of the sitsit is 25 €. Payment is made by bank transfer to the account of Oulun Tietoteekkarit ry: FI11 7997 7997 9204 70.
Write "your name + fuksisitsit" in the message field. If you have any questions, you can contact us via email at pepeministeri@otit.fi.
